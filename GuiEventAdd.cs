...
namespace SecondSight
{
    public partial class MainForm
    {
        ...
        private void tb_Add_AddOD_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Convert.ToSingle(tb_Add_AddOD.Text) != 0)
                { //If AddOD is a nonzero number
                    rb_Add_Multi.Checked = true;
                }
                else if (Convert.ToSingle(tb_Add_AddOS.Text) == 0)
                { //else if AddOS (not a typo) is also zero
        ...
        private void tb_Add_AddOS_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Convert.ToSingle(tb_Add_AddOS.Text) != 0)
                { //If AddOS is a nonzero number
                    rb_Add_Multi.Checked = true;
                }
                else if (Convert.ToSingle(tb_Add_AddOD.Text) == 0)
                { //else if AddOD (not a typo) is also zero
                    rb_Add_Single.Checked = true;
                }
            }
            catch { }
        ...
        private void Add_SphereLock_Process(bool _isOD)
        {
            try
            {
                if (_isOD == true)
                {
                    if (chb_Add_SphereLockOD.Checked == true)
                    { //Change OD sphere to negative
                ...
                {
                    if (chb_Add_SphereLockOS.Checked == true)
                    { //Change OS sphere to negative
