    ...
    partial class MainForm
    {
        ...
        private void Enable_AllControls(bool _enable)
        {
            if (_enable)
            {
                ...
                if (tabc_MainForm.TabPages.Count == 1)
                { //If the tabs have been removed, re-add them, otherwise do nothing
        ...
        private bool Rx_TextBox_Valid(TextBoxBase tb, RxBox box)
        {
            ...
            if (box == RxBox.Axis)
            {
                ...
                try
                { //Is the contents a valid integer?
            ...
            else //Sphere, Cylinder or Add
            {
                ...
                try
                { //Is the contents a valid real number?
